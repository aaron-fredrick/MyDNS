...
/// Backend-owned operational metrics consumed by the management API.
///
/// Samples are intentionally bounded by both count and age. This keeps
/// percentile calculations useful without retaining unbounded per-request data.
pub struct Metrics {
    started: Instant,
    queries: AtomicU64,
    ...
    pub fn snapshot(&self) -> serde_json::Value {
        ...
        serde_json::json!({
            ...
            "upstream": {
                ...
                "latency_ms": percentile_stats(&upstream_values)
            },
