CREATE TABLE IF NOT EXISTS operational_periods (
    ...
    resolution_outcomes TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_historical_buckets_timestamp
    ON historical_buckets(timestamp);

CREATE INDEX IF NOT EXISTS idx_historical_buckets_resolution_time
    ON historical_buckets(resolution_seconds, timestamp);
